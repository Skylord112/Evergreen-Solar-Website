...
if ( version_compare( phpversion(), '5.6' ) >= 0 ) {
	...
	spl_autoload_register(
		function( $class ) {
			$rocket_path    = '/home/evergreensolar/public_html/wp-content/plugins/WP-Rocket-by-WP-Media-3.5.1/';
			$rocket_classes = [
	...
	$rocket_config_class = new \WP_Rocket\Buffer\Config(
		[
			'config_dir_path' => '/home/evergreensolar/public_html/wp-content/wp-rocket-config/',
		]
	);
	...
	( new \WP_Rocket\Buffer\Cache(
		...
		$rocket_config_class,
		[
			'cache_dir_path' => '/home/evergreensolar/public_html/wp-content/cache/wp-rocket/',
		]
	) )->maybe_init_process();
} else {
